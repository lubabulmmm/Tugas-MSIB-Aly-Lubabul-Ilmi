<footer class="p-4 sm:p-6 bg-amber-500">
    <div class="mx-auto max-w-screen-xl pt-2">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="#" class="flex items-center">
                    <img src="/pbl/assets/img/logo.png" class="mr-3 h-8" alt="FlowBite Logo" />
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-amber-500 sm:text-center text-white">© 2023 <a href="https://flowbite.com"
                    class="hover:underline">PBL Vokasi</a>. All Rights Reserved.
            </span>
